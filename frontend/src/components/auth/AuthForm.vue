...
<template>
	<form class="form" @submit="handleSubmit">
		...
		<input class="form__element form__input" type="text" placeholder="login" name="login" v-model="login" />
		...
		<input
			...
			name="password"
		/>
		<button class="form__element form__button" type="submit">LOGIN</button>
	</form>
</template>
