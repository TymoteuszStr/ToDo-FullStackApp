<template>
  <div class="general">
    <div class="general__text-container" @click.stop="titleClickHandle">
      <input v-if="editMode" class="general__text-container__input" type="text" v-model="inputText" ref="textInput" @keydown="inputValidation" />
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const inputValidation = (e: Event) => {
      // if (inputText.value.length > 60) e.preventDefault();
    };
