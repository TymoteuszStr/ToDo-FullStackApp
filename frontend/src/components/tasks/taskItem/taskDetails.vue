...
<template>
	<div class="details">
		...
		<div class="details--text-container" @click="descriptionClickHandle">
			<input
				v-if="editMode"
				class="details--text-container__input"
				type="text"
				v-model="inputText"
				ref="textInputRef"
				@keydown="inputValidation"
			/>
			<p v-else class="details--text-container__description"><slot /></p>
		</div>
	</div>
</template>
...
<style lang="scss" scoped>
	...
	.details {
		...
		&--text-container {
			...
			&__input {
				@extend .details--text-container__description;
